...
export const metadata: Metadata = {
  title: "Programme de fidélité Bazario | Bazario",
  description:
    "Cumulez des Bazario Coins sur chaque achat de produit digital et débloquez des avantages exclusifs. Gratuit, ou boosté avec l'abonnement Nexus+.",
  alternates: { canonical: `${SITE_URL}/loyalty` },
  openGraph: {
    title: "Programme de fidélité Bazario — récompensez chaque achat",
    description:
      "Bazario Coins, crédits IA, accès anticipé aux drops et support prioritaire.",
...
const TIERS = [
  {
    ...
    icon: Sparkles,
    perks: [
      "1 % en Bazario Coins sur chaque achat",
      "Livraison numérique instantanée",
      "Garantie 14 jours satisfait ou remboursé",
      "Newsletter membre & drops du jour",
    ],
  ...
  },
  {
    name: "Nexus+",
    monthly: "9,99 € / mois",
    yearly: "99,90 € / an (2 mois offerts)",
    description: "Notre abonnement premium pour les créateurs et acheteurs réguliers.",
    icon: Crown,
    perks: [
      ...
      "3 % en Bazario Coins sur chaque achat",
    ],
  ...
  },
  {
    ...
    yearly: "299 € / an",
    description: "Pour les créateurs power-users et studios.",
    icon: Tag,
    perks: [
      "5 % en Bazario Coins + crédits IA doublés",
      "Account manager dédié et drops privés",
      "Licences agence incluses sur produits éligibles",
      "Préemption sur les éditions limitées",
      "Invitations aux événements Bazario",
    ],
    accent: "from-secondary to-secondary",
    highlight: false,
  },
