# Pack 800 prompts Midjourney cinématiques — style blockbuster

> 800 prompts photo-réalistes calibrés pour Midjourney v7 : éclairages de cinéma, palettes étalonnées, focales précises. Inclut un guide des paramètres avancés et 50 styles signature prêts à copier-coller.

**Créateur :** PromptCraft Lab
**Catégorie :** Prompts & GPTs › Créatif › Midjourney
**Licence(s) :** Pack complet
